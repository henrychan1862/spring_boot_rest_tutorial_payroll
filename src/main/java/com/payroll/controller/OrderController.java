...
import com.payroll.exceptions.OrderNotFoundException;
...
public class OrderController {
    ...
    public ResponseEntity<?> complete(@PathVariable Long id) {
        ...
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
                ...
                .body(Problem.create().withTitle("Method not allowed").withDetail("You can't complete an oprder that is in the " + order.getStatus() + " status"));
    }
